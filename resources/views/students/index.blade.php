<x-app-layout>
    ...
    <a href="{{ route('student.create') }}"
        class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 m-8 mb-0 mt-4 inline-block">Add Students</a>
        ...
        <table class="w-[100%] divide-gray-200">
            <thead class='bg-gray-200'>
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700">Student Id</th>
            ...
            <tbody class="divide-y divide-gray-200">
                @foreach ($students as $student)
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-3 text-left text-sm text-gray-900">{{$student->name}} </td>
                        <td class="px-6 py-3 text-left text-sm text-gray-900">{{$student->student_id}} </td>
